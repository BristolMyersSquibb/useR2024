...
# A cooking approach to data science {background-image="assets/img/gratin.jpeg" background-size="40%" data-stack-name="Intro" style="margin-top: -350px; font-size: 1.5em;"}
...
## {background-video="assets/movies/palmer-penguins-blockr-demo.mov"}
...
## {background-video="assets/movies/palmer-penguins-workspace-demo.mov"}
