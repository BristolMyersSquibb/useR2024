...
# A cooking approach to data science {background-image="assets/img/undraw_diet_ghvw.svg" background-size="contain" data-stack-name="Intro" style="margin-top: 450px; font-size: 1.5em"}
...
## ![shiny homepage](assets/img/easy-browser.png){.center width=100%}

## ![shiny homepage corrected](assets/img/notsoeasy-browser.png){.center width=100%}
...
Plot me a histogram showing `flipper length` as function of `body mass` by `species` only for `female` penguins.
...
## Connecting stacks: towards a dinner party {background-image="assets/img/undraw_special_event.svg" background-size="contain" style="margin-top: -50px; font-size: 1.5em"}
...
## TBD: workspace demo {style="font-size: 1.5em"}
...
## How far can I go with blockr? {background-image="assets/img/undraw_add_post_re_174w.svg" background-size="cover" style="margin-left: 400px; margin-top: 700px; font-size: 1.5em"}



# Create your own block supermarket {data-stack-name="Extend" background-image="assets/img/undraw_empty_cart_co35.svg" background-size="cover" style="margin-top: -300px; font-size: 1.5em"}
...
# We need you! {data-stack-name="Conclusion" background-image="assets/img/undraw_co_workers_re_1i6i.svg" style="font-size: 1.5em"}
...
:::{.column}
![](assets/img/undraw_data_trends_re_2cdy.svg){fig-width="50%"}
:::
...
:::{.column}
![](assets/img/undraw_building_blocks_re_5ahy.svg){fig-width="50%"}
:::
...
# Appendix {data-stack-name="Appendix"}
