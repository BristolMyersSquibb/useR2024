...
## Develop enterprise-grade dashboards isn't easy {background-image="assets/img/undraw_lost_re_xqjt.svg" background-size="contain" style="font-size: 1.5em"}
...
## {background-image="assets/img/undraw_diet_ghvw.svg" background-size="contain"}


### A cooking approach to data science {style="margin-top: 800px; font-size: 2em"}
...
# bockr 101 {data-stack-name="blockr 101" background-image="assets/img/undraw_cooking_p7m1.svg" background-size="contain" style="margin-top: -150px; margin-left: 50px;"}
